...
{
    public class RaporFiltreAddModel: RaporFiltreTanimModel
    {
        public static explicit operator TblmbraporFiltre(RaporFiltreAddModel model)
        {
            return new TblmbraporFiltre
            {
                Id = model.Id,
